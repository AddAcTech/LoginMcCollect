                ...
                <div class="form-control">
                    ...
                    <div class="input-container">
                        <div class="label-input">
                            ...
                            <asp:TextBox ID="tbUsuario" CssClass="form-inputs" runat="server" placeholder="Ingrese correo electronico"  OnTextChanged="tbUsuario_TextChanged"  ></asp:TextBox>
                        </div>
                    ...
                    <div class="input-container"->
                        <div class="label-input">
                            ...
                            <asp:TextBox ID="tbNombre" CssClass="form-inputs" runat="server" placeholder="Ingrese nombre completo"  OnTextChanged="tbNombre_TextChanged"  ></asp:TextBox>
                        </div>
                    ...
                    <div class="input-container">
                        ...
                        <div class="label-input">
                            ...
                            <asp:TextBox ID="tbPassword" CssClass="form-inputs" TextMode="Password" runat="server" placeholder="Ingrese contraseña"  OnTextChanged="tbPassword_TextChanged" ></asp:TextBox>
                        </div>
                    ...
                    <div class="input-container">
                        <div class="label-input">
                            ...
                            <asp:TextBox ID="tbConfirmarPassword" CssClass="form-inputs" TextMode="Password" runat="server" placeholder="Repita su contraseña"  OnTextChanged="tbConfirmarPassword_TextChanged" ></asp:TextBox>
                        </div>
                    ...
                    <div class="input-container">
                        <div class="label-input">
                            ...
                            <asp:TextBox ID="tbDireccion" CssClass="form-inputs" runat="server" placeholder="Ingrese la dirección"  OnTextChanged="tbDireccion_TextChanged"  ></asp:TextBox>
                        </div>
                    ...
                    <div class="input-container">
                        <div class="label-input">
                            ...
                            <asp:TextBox ID="tbCp" CssClass="form-inputs" runat="server" placeholder="Ingrese el codigo postal  "  MaxLength="5" OnTextChanged="tbCp_TextChanged"  ></asp:TextBox>
                        </div>
                    ...
                    <div class="input-container">
                        <div class="label-input">
                            ...
                            <asp:TextBox ID="tbPromedio" CssClass="form-inputs" runat="server" placeholder="Ingrese el promedio"  OnTextChanged="tbPromedio_TextChanged"  ></asp:TextBox>
                        </div>
                    ...
                    <div class="input-container">
                        <div class="label-input">
                            ...
                            <asp:TextBox ID="tbNacimiento" CssClass="form-inputs"  runat="server" placeholder="AAAA-MM-DD"  OnTextChanged="tbNacimiento_TextChanged"  ></asp:TextBox>
                        </div>
                        <asp:Label runat="server" CssClass="alert-danger" ID="lblErrorNacimiento"></asp:Label>
                    </div>

                    <div class="row">
                        <asp:Label runat="server" CssClass="alert-success" ID="lblAlta"></asp:Label>
